...
template < class R_ >
class K_VisSegment_2 : R_::Point_2
{
...
public:
  ...
  bool        operator==(const K_VisSegment_2 &s) const;
  bool        operator!=(const K_VisSegment_2 &s) const;
...
inline
bool
K_VisSegment_2<R>::operator==(const K_VisSegment_2<R> &s) const
{
...
template < class R >
CGAL_KERNEL_INLINE
const typename K_VisSegment_2<R>::Point_2 &
K_VisSegment_2<R>::min BOOST_PREVENT_MACRO_SUBSTITUTION () const
{
...
CGAL_KERNEL_INLINE
const typename K_VisSegment_2<R>::Point_2 &
K_VisSegment_2<R>::max BOOST_PREVENT_MACRO_SUBSTITUTION() const
{
  typename R::Less_xy_2 less_xy;
...
CGAL_KERNEL_INLINE
const typename K_VisSegment_2<R>::Point_2 &
K_VisSegment_2<R>::vertex(int i) const
{
...
CGAL_KERNEL_INLINE
const typename K_VisSegment_2<R>::Point_2 &
K_VisSegment_2<R>::point(int i) const
{
  return (i%2 == 0) ? source() : target();
}
...
inline
const typename K_VisSegment_2<R>::Point_2 &
K_VisSegment_2<R>::operator[](int i) const
{
  return vertex(i);
}
...
template < class R >
CGAL_KERNEL_INLINE
typename K_VisSegment_2<R>::FT
K_VisSegment_2<R>::squared_length() const
{
...
template < class R >
CGAL_KERNEL_INLINE
typename K_VisSegment_2<R>::Direction_2
K_VisSegment_2<R>::direction() const
{
...
template < class R >
CGAL_KERNEL_INLINE
typename K_VisSegment_2<R>::Vector_2
K_VisSegment_2<R>::to_vector() const
{
  typename R::Construct_vector_2 construct_vector;
...
template < class R >
inline
typename K_VisSegment_2<R>::Line_2
K_VisSegment_2<R>::supporting_line() const
{
...
inline
bool
K_VisSegment_2<R>::is_degenerate() const
{
...
CGAL_KERNEL_INLINE
bool
K_VisSegment_2<R>::is_horizontal() const
{
  return R().equal_y_2_object()(source(), target());
}
...
CGAL_KERNEL_INLINE
bool
K_VisSegment_2<R>::is_vertical() const
{
...
bool
K_VisSegment_2<R>::
has_on(const typename K_VisSegment_2<R>::Point_2 &p) const
{
...
bool
K_VisSegment_2<R>::
collinear_has_on(const typename K_VisSegment_2<R>::Point_2 &p) const
{
...
template < class R >
std::ostream &
operator<<(std::ostream &os, const K_VisSegment_2<R> &s)
{
...
template < class R >
std::istream &
operator>>(std::istream &is, K_VisSegment_2<R> &s)
{
